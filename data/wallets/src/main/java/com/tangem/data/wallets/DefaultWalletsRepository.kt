...
internal class DefaultWalletsRepository(
    ...
    private suspend fun fetchSeedPhraseNotificationStatus(userWalletId: UserWalletId) {
        ...
        seedPhraseNotificationVisibilityStore.update(id = userWalletId, value = status)
    }
    ...
    override suspend fun confirmSeedPhraseNotification(userWalletId: UserWalletId) {
        ...
        seedPhraseNotificationVisibilityStore.update(id = userWalletId, value = false)
    }
    ...
    private suspend fun RuntimeStateStore<Map<UserWalletId, Boolean>>.update(id: UserWalletId, value: Boolean) {
        return update {
